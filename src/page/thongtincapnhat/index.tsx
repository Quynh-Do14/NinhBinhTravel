...
let timeout: any
const ListThongTinCapNhatManagement = () => {
    ...
    return (
        <MainLayout
            title={'Danh sách thông tin cập nhật'}
            breadcrumb={'thông tin cập nhật'}
                ...
                <div className="content">
                    <Row gutter={[20, 20]}>
                        ...
                        <Col xs={24} sm={18} className='flex justify-end'>
                            <ButtonCommon
                                classColor={'red'}
                                onClick={() => navigate(ROUTE_PATH.ADD_THONGTINCAPNHAT_MANAGEMENT)}
                                title={'Thêm mới'}
                            />
                        </Col>
                    </Row>
                    ...
                    <DialogConfirmCommon
                        message={"Bạn có muốn xóa thông tin cập nhật này ra khỏi hệ thống"}
                        titleCancel={"Bỏ qua"}
                        titleOk={"Xóa thông tin cập nhật"}
...
export default ListThongTinCapNhatManagement