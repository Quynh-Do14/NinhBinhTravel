...
const ListDanhMucLopDuLieuManagement = () => {
    ...
    const onDeleteAsync = async () => {
        try {
            await danhmucService.DeleteDanhmuc(
                idSelected,
                setLoading
            ).then((res) => {
                if (res) {
                ...
                <div className="content">
                    <Row gutter={[20, 20]}>
                        ...
                        <Col xs={24} sm={18} className='flex justify-end'>
                            <ButtonCommon
                                classColor={'red'}
                                onClick={() => navigate(ROUTE_PATH.ADD_DANH_MUC_LOP_DU_LIEU_MANAGEMENT)}
                                title={'Thêm mới'}
                            />
                        </Col>
                    </Row>
                            ...
                            <Column
                                ...
                                render={(action, record: any) => (
                                    <ActionCommon
                                        ...
                                        onClickDelete={() => onOpenModalDelete(record.iddanhmuclopbando)}
